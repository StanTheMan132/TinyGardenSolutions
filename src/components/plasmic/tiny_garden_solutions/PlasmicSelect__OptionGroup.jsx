...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: sOvqC3Coibm/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Ric4jps1ZGe/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__k1Hzd)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__fYbU)}
              />
            </React.Fragment>
          ),
