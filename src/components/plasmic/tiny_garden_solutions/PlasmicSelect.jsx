...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: gAsGPeXmSnS/component
import Select__Option from "../../Select__Option"; // plasmic-import: 6R7wK_O9k4U/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: sOvqC3Coibm/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Ric4jps1ZGe/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: hPWiErNdFWp/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: AGPM0L-f5nJ/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__alc5)}
                      value={"value1"}
                    >
                      {"Option 1"}
                    </Select__Option>
      ...
      props = {
        ...
        children: (
          <React.Fragment>
            ...
            <Select__Option
              className={classNames("__wab_instance", sty.option___5DCl)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
